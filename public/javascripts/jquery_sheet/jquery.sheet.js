...
function castillian(d){
                                        d= d.replace(/á/gi,"&aacute;");
                                        d= d.replace(/é/gi,"&eacute;");
                                        d= d.replace(/í/gi,"&iacute;");
                                        d= d.replace(/ó/gi,"&oacute;");
                                        d= d.replace(/ú/gi,"&úacute;");

                                        d= d.replace(/Á/gi,"&Aacute;");
                                        d= d.replace(/É/gi,"&Eacute;");
                                        d= d.replace(/Í/gi,"&Iacute;");
                                        d= d.replace(/Ó/gi,"&Oacute;");
                                        d= d.replace(/Ú/gi,"&Uacute;");

                                        d= d.replace(/ñ/gi,"&atilde;");
                                        d= d.replace(/Ñ/gi,"&Atilde;");

                                        d= d.replace("Ñ","&Atilde;");
                                        d= d.replace("ñ","&atilde;");        
  return d;
	...
	sheet: function(settings) {
		jQuery(this).each(function() {
			...
			var set = jQuery.extend({
				urlGet: 			"../javascripts/jquery_sheet/sheets/enduser.documentation.html", //local url, if you want to get a sheet from a url
			//	urlSave: 			"http://cudi/cudidocs/datasheetsave", 					//local url, for use only with the default save for sheet
                                urlSave:                        "cudidocs/datasheetsave",
				...
				urlMenu: 			"../javascripts/jquery_sheet/menu.html", 					//local url, for the menu to the left of title
				...
				fnSave: 			function() {   parent.getSheet().saveSheet(); }, //fn, default save function, more of a proof of concept
                                fnSaveas:                       function() { 
                                                                              ...
                                                                              $('#tempfn').val('');
                                                                             // parent.getSheet().saveasSheet(); 
                                                                              $("#asave").click(); return false;
                                                                            },
				fnOpen: 			function() { 					//fn, by default allows you to paste table html into a javascript prompt for you to see what it looks likes if you where to use sheet
                                                                                ...
                                                                                if ($("#htmlcontain").val().length > 0 ){
                                                                                
                                                                                                                                                                       
                                                                                  //var tf= $("#tempfn").val();
                                                                                   
                                                                                  var t = $("#htmlcontain").val();
                                ...
                                fnOpena:                         function() {                                    //fn, by default allows you to paste table html into a javascript prompt for you to see what it looks likes if you where to use sheet
                                                                                var t = $("#htmlcontain").val();
                                                                                if (t) {
                                                                                        parent.getSheet().openSheet(t);
                                                                                }
				...
				minSize: 			{rows: 15, cols: 10},			//object - {rows: int, cols: int}, Makes the sheet stay at a certain size when loaded in edit mode, to make modification more productive
						...
						case "row":
							o = {
								...
								newCells: function() {
									...
									return '<tr marca="1" style="height: ' + s.colMargin + 'px;">' + newCells + '</tr>';
								},
								newCol: '',
								reLabel: function() {								
				...
				//var v = jS.sheetDecorateRemove(true);
                               ...
                               d=encodeURI(d); 
                                ...
                                if (!fn.length){ 
                                  ...
                                  //    $('#fn').focus();
                                      var men='';
                                      men= $('#jSheetEditPane_0_0').html();
                                    
                                      $('#jSheetEditPane_0_0').empty();  
                                      var sa='';    
                                     
                                    
                                var app='';
                                 v = prompt("nombre del fichero");
                                /* 
                                app= apprise('Nombre de fichero',{'input':true}, function(r)
                                { 
                                  if(r)
                                  {
                                        $('#fn').val(r);
                                        $('#tempfn').val(r);                                        
                                        $('#jSheetEditPane_0_0').html(men);

      var jqxhr = $.post(s.urlSave,'contain=' + escape(d) +';fid="' + sv + '";fn=' + r ,  function(d) {
    ...
    jqxhr.complete(function(){ 
                                  ...
                                  */
                                  ...
                                  if(v){
                                    ...
                                    $('#tempfn').val(v);                                        
                                    $('#jSheetEditPane_0_0').html(men);
                                    var jqxhr = $.post(s.urlSave,'contain=' + escape(d) +';fid="' + sv + '";fn=' + v ,  function(d) {
                                    })
                                    .success(function() {
                                     })
                                    .error(function() { 
                                  ...
                                  //    alert('no v');
                                      ...
                                      $('#jSheetTitle_0').empty();
                                      $('#jSheetTitle_0').html('Proporciona un nombre'); 
                                      ...
                                      //  d=castillian(d); 
                                        ...
                                        url: s.urlSave,
                                        type: 'POST',
                                        data: 'contain=' + escape(d)  +';fid=' + sv + ';fn=' + fn  ,
                                ...
                                //d='todo lo que yo ponga aqui debería de grabarse siiiiiiiiiiiiiiiiiiiiiiiiiiiiinnnnnnnnnnnnnnnnnnnoproblemassssssssssssssssssssssssssssssxxx';
                           
			},
                        saveasSheet: function() { /* saves the sheet */
                                ...
                                if (fn.lenght == 0) fn='file_name';
                                v = prompt("nombre del fichero");
                                if(v){
                                  $('#jSheetEditPane_0_0').html(men).html();
                                  jQuery.ajax({
                                        url: s.urlSave,
                                        type: 'POST',
                                   
                                        data: 'contain=' + escape(d)  +';id=' + sv + ';fn=' + r  ,
			...
			newSheet: function() { /* creates a new shet from size */
                                /* borrar el nombre del anterior fichero */
